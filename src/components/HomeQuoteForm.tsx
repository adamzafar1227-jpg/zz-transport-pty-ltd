    ...
    <section id="quote-form-section" className="py-20 bg-[#111111] text-white relative overflow-hidden border-b border-[#1F1F1F]">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="text-center mb-12">
          <h2 className="font-display font-[900] text-2xl sm:text-3xl text-white tracking-tight uppercase" id="quote-section-header">
            REQUEST A QUOTE
          </h2>
                ...
                >
                  ...
                  <div>
                    ...
                    <textarea
                      ...
                      placeholder="Please detail your cargo specs, weight, container counts, and loading requirements..."
                      style={{ height: '100px' }}
